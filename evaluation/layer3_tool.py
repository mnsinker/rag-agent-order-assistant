...
cases = [
    ...
    { # case 2: 可退款
        "tool": "check_refund",
        "params": {"order_id": "123"},
        "expected": RefundEligibility(False, "product is already shipped")
    },
    { # case 3: 不可退款 - 已发货
        "tool": "check_refund",
        "params": {"order_id": "789"},
        "expected": RefundEligibility(False, "custom product doesn't support refund")
    },
    { # case 4: 不可退款 - 定制商品
        "tool": "check_refund",
        "params": {"order_id": "789"},
    ...
    { # case 5: 可执行退款
        ...
        "params": {
            "order_id": "123",
            "eligibility": RefundEligibility(True, "eligible for refund")
        },
        "expected": RefundExecutionResult(True, 'refund initiated')
    },
    { # case 6: 不可执行退款
        "tool": "create_refund",
        "params": {
            "order_id": "123",
            "eligibility": RefundEligibility(False, "product is already shipped")
        },
        "expected": RefundExecutionResult(False, 'not eligible to refund')
    }
]
